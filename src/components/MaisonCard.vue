...
<template>
  <div
    ...
    <div class="self-stretch flex-grow-0 flex-shrink-0 h-[200px]">
      <div class="w-[394.67px] h-[200px] absolute left-[-0.5px] top-[-0.5px] rounded-tl-lg rounded-tr-lg bg-gray-500">
      </div>
    ...
    <div
      ...
      <div class="flex justify-between items-start self-stretch flex-grow-0 flex-shrink-0 relative">
        ...
        <svg width="49" height="48" viewBox="0 0 49 48" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          <circle cx="24.6666" cy="24" r="23.25" fill="white" stroke="#E0E7FF" stroke-width="1.5"></circle>
          <path
      ...
      <svg width="355" height="2" viewBox="0 0 355 2" fill="none" xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 gap-1.5">
        ...
        <div class="flex justify-center items-center flex-grow relative gap-2">
          <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg"
            class="flex-grow-0 flex-shrink-0 w-5 h-5 relative" preserveAspectRatio="xMidYMid meet">
            <g clip-path="url(#clip0_34922_575)">
              <path
              ...
              <path
                ...
                stroke="#6366F1" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M3.66663 17.5L4.49996 16.25" stroke="#6366F1" stroke-width="1.66667" stroke-linecap="round"
                stroke-linejoin="round"></path>
              <path d="M17 17.5L16.1666 16.25" stroke="#6366F1" stroke-width="1.66667" stroke-linecap="round"
                stroke-linejoin="round"></path>
            </g>
            <defs>
              <clipPath id="clip0_34922_575">
        ...
        <div class="flex justify-end items-center flex-grow relative gap-2">
          <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <g clip-path="url(#clip0_34922_585)">
              <path
                ...
                stroke="#6366F1" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M2.6665 13.1716L7.03022 17.5353" stroke="#6366F1" stroke-width="1.66667" stroke-linecap="round"
                stroke-linejoin="round"></path>
              <path d="M14.3029 17.5353L18.6666 13.1716" stroke="#6366F1" stroke-width="1.66667" stroke-linecap="round"
                stroke-linejoin="round"></path>
            </g>
            <defs>
              <clipPath id="clip0_34922_585">
